                ...
                <table className="w-full text-left border-collapse ">
                    <thead className="text-xs bg-white uppercase text-[#374151] font-semibold sticky top-0 z-10 border-b border-gray-300">
                        <tr>
                            ...
                            <th className="px-3 py-3">Sub Title</th>
                            ...
                            currentItems.map((banner) => (
                                <tr key={banner.id} className="hover:bg-blue-50/50 transition text-sm text-[#334155]">
                                    <td className="px-3 py-3">
                                        <img src={banner.image} alt="banner" className="min-w-20 min-h-10 max-w-20 max-h-10 object-cover rounded border border-gray-200" />
                                    </td>
                                    <td className="px-3 py-3 text-sm font-normal whitespace-nowrap">{banner.title}</td>
                                    <td className="px-3 py-3 text-sm font-normal whitespace-nowrap">{banner.subtitle}</td>
                                    <td className="px-3 py-3 text-[#334155] max-w-[200px] font-normal text-sm truncate whitespace-nowrap">{banner.description}</td>
                                    {/* <td className="px-3 py-3 text-center text-[#334155] font-normal text-sm">{banner.type}</td> */}
